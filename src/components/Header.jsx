export const Header = ({ showAddForm, onToggleForm, onLogout, isAdmin }) => {
  return (
          ...
          <div className="flex space-x-3">
            {isAdmin && (
              < button
                ...
                className={`w-full sm:w-auto px-1 py-3 font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:scale-105 ${showAddForm
